    ...
    const handleSubmit = async(e) =>{
        ...
        try{
            ...
            if (response.data && response.data.username){
                ...
                navigate(`/profile/${response.data.username}`, { state: response.data });
            }else {
        ...
        <div className="bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 min-h-screen flex justify-center items-center ">
                <div className="flex items-center justify-center flex-col border-white bg-white p-10 rounded-md ">
                    ...
                    <div className="flex items-center flex-col gap-6">
                        <input className="w-80 p-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-400" placeholder="email" onChange={(e) => setUsername(e.target.value)} />
