...
//                             <label className="block text-white font-semibold">Select Address:</label>
//                             <select
...
//                             {addresses.map((addr) => (
//                                 <option key={addr._id} value={`${addr.name}, ${addr.street}, ${addr.city}, ${addr.state}, ${addr.zip}, ${addr.phone}`}>
