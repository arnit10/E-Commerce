...
const About = () => {
  return (
    <div className=' bg-white px-6 py-12 text-center'>
      ...
      <p className='text-lg text-gray-700 max-w-3xl mx-auto mb-6'>Welcome to <span className='text-blue-600 font-semibold'> E-commerce </span> your go-to destination for quality products and unbeatable prices. We’re passionate about bringing you the best items across a wide range of categories, all in one convenient place.</p>
